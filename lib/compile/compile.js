...
const RENDER_SCOPE_SYMBOL = Symbol('Mus#renderScope');
...
class Compiler {
  ...
  get renderScope() {
    if (this.parent) {
      return this.parent.renderScope;
    }

    if (!this[RENDER_SCOPE_SYMBOL]) {
      this[RENDER_SCOPE_SYMBOL] = {};
    }

    return this[RENDER_SCOPE_SYMBOL];
  }
